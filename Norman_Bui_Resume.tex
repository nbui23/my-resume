...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading{Autodesk}{Incoming Software Developer Intern $|$ Java, TypeScript, GraphQL}{Jan 2025 - Apr 2025}
        \resumeItemListStart
            \resumeItem{Will be working on cloud-based CAD/CAM development for Autodesk's Fusion platform}
    \resumeItemListEnd
