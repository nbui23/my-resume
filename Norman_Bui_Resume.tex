...
\section{\textbf{\Large Education}}
  ...
  {Expected April 2026}
      \resumeItemListStart
        ...
        \resumeItem{Relevant Coursework: Data Structures \& Algorithms, Discrete Math and Structures, OS, OOP, Paradigms, Web Development, QA, HCI (UI/UX), Database Management Systems, Statistical Modeling, Calculus, Linear Algebra}
      \resumeItemListEnd
...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading{Autodesk}{Incoming Software Developer Intern - Java, TypeScript, GraphQL}{Jan 2025}
        \resumeItemListStart
            \resumeItem{Will be working on cloud-based CAD/CAM development for Autodesk's Fusion platform \textbf{(Winter 2025)}}
    \resumeItemListEnd

    \resumeSubheading{Public Health Agency of Canada}{Junior Data Scientist - Python, LLM, MDM}{Sep 2024 - Present}
      \resumeItemListStart
        \resumeItem{Developing LLM-powered workflow for epidemiological literature reviews with Imperial College London and WHO as part of master data management system to enable standardized research access for global health initiatives}
      \resumeItemListEnd
    ...
    % \resumeSubheading
    % {Junior Web Developer}{Correctional Service Canada - C\#, .NET, Web, QA}{May 2022 - Apr 2023}
    %   \resumeItemListStart
