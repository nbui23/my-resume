    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading{SocialSaplings}{HTML/SCSS, JavaScript, Bootstrap, Node, Express, Firebase (Firestore, Auth)}{\href{https://devpost.com/software/socialsaplings}{\underline{Devpost}}}
            \resumeItemListStart
                ...
                \resumeItem{Implemented a tool using \textbf{GBIF, SoilGrids, Open-Elevation, and OpenWeatherMap} to recommend optimal tree species based on a user's geodata.}
                \resumeItem{Developed a tree planting visualization tool with \textbf{Google Maps API} to showcase global reforestation impact.}
                \resumeItem{Added profiles, posts, likes, and comments, using \textbf{Firebase} for data management and authentication.}
            \resumeItemListEnd
