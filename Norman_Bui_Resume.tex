  ...
  \resumeSubHeadingListStart
    ...
    {Carleton University}{Bachelor of Computer Science (Honours), \textbf{3.9/4.0 GPA}}{{Expected May 2025}}
      \resumeItemListStart
        ...
        \resumeItem{Relevant Coursework: Design \& Analysis of Algorithms, Discrete Structures II, Web Apps, Operating Systems, Object-Oriented Software Engineering, Statistics, Paradigms, HCI, Databases}
      \resumeItemListEnd
...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Developing C++ engineering solutions for TerraLens and IRIS platforms, focusing on \textbf{geospatial data visualization} and \textbf{real-time tracking}.}
      \resumeItemListEnd
    ...
    % \resumeSubheading
    % {Correctional Service Canada}{Software Developer Intern - Victim Application Modernization}{May 2022 - Apr 2023}
    %   \resumeItemListStart
...
\section{\textbf{\Large Projects}}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading{SocialSaplings}{HTML/CSS, JavaScript, Bootstrap, Node, Express, Firebase (Firestore, Auth)}{\href{https://devpost.com/software/socialsaplings}{\underline{Devpost}}}
            \resumeItemListStart
                ...
                \resumeItem{Implemented a tool using \textbf{various APIs} to recommend optimal tree species based on a user's location data.}
                \resumeItem{Developed a tree planting visualization with \textbf{Google Maps API} to showcase global reforestation impact.}
                \resumeItem{Added features like profiles, posts, likes, and comments, using \textbf{Firebase} for data management and authentication.}
            \resumeItemListEnd
