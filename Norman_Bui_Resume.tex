...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Correctional Service Canada}{Junior Web Developer $|$ C\#, .NET, Web Development, QA}{May 2022 - Apr 2023}
      \resumeItemListStart
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading{Pomodojo}{HTML/CSS, JavaScript, Bootstrap, Node.js, Express.js, MongoDB, WebRTC}{\href{https://devpost.com/software/pomodorm}{\includegraphics[height=0.37cm]{logos/devpost.png}}}
            \resumeItemListStart
                ...
                \resumeItem{Integrated WebRTC and Agora APIs to enable multi-user video conferencing capabilities, ensuring stable real-time communication for up to 10 concurrent users with \textbf{sub-100ms latency}}
