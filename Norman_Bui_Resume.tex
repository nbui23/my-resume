...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Building a QSAR \textbf{machine learning} model with pandas, NumPy, and scikit-learn to \textbf{predict chemical toxicity}}
        \resumeItem{Using \textbf{data science} and SciPy to build a \textbf{data analysis pipeline} that analyzes features linked to estrogen activity}
      \resumeItemListEnd
    ...
    {Department of National Defence}{Software Developer}{June 2023 - Present}
      \resumeItemListStart
        ...
        \resumeItem{Incorporating \textbf{OpenAI} for high-dimensional embeddings, enhancing \textbf{contextual response relevance}}
        \resumeItem{Using \textbf{SQLite3} and \textbf{FAISS} for efficient storage and embedding retrieval, enabling \textbf{quick semantic text retrieval}}
      \resumeItemListEnd
