    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading{SocialSaplings}{HTML/CSS, JavaScript, Node, Express, Firebase (Firestore, Auth)}{\href{https://devpost.com/software/socialsaplings}{\underline{Devpost}}}
            \resumeItemListStart
                ...
                \resumeItem{Used the Google Maps API to create a global tree planting visualization feature, demonstrating the collective impact of reforestation efforts.}
            \resumeItemListEnd
...
\section{\textbf{\Large Skills}}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Frameworks}{: Flask, Express, Bootstrap, Web Experience Toolkit} \\[0.25em]
    \textbf{Databases}{: Neo4J, MySQL, SQLite3, Firebase, MongoDB, PostgreSQL} \\[0.25em]
