...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Build a QSAR \textbf{machine learning} model with pandas, NumPy, and scikit-learn to \textbf{predict chemical toxicity}}
        \resumeItem{Use \textbf{data science} and SciPy to build a \textbf{data analysis pipeline} that analyzes features linked to estrogen activity}
      \resumeItemListEnd

    \resumeSubheading
    {Department of National Defence}{Software Developer}{June 2023 - Present}
      \resumeItemListStart
        \resumeItem{Build a bilingual chatbot with Flask and GPT-3.5 to \textbf{simulate conversation with a local document database}}
        \resumeItem{Implement an \textbf{NLP pipeline} using PyPDF2 and NLTK for semantic transformation of PDFs}
