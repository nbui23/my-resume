  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Used data science and SciPy to build a \textbf{data analysis pipeline} that analyzes features linked to estrogen activity}
        ...
        \resumeItem{Refactored the federated search system's codebase for risk data analysis, integrating session management, automatic retries, and dynamic rate limiting, significantly enhancing system maintainability and reliability}
        \resumeItem{Developed suite of unit tests using unittest for federated search system, augmenting integrity and reliability}
      \resumeItemListEnd
