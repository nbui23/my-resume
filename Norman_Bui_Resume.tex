...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Built machine learning models with pandas, NumPy, and scikit-learn to \textbf{help predict chemical toxicity}}
        ...
        \resumeItem{Restored web scraping scripts with BeautifulSoup4 and lxml to aggregate various sources of chemical data}
      \resumeItemListEnd
